...
impl SchemaProviderApi for _FakeProvider {
    fn lookup_request_schema(
        ...
        Arc<crate::schema_provider::schema_provider::CompiledJsonSchema>,
    > {
        None
    }
...
fn violation_kind_emits_canonical_expected_strings() {
    ...
    assert_eq!(ViolationKind::FieldMissing.as_expected_str(), "field_missing");
    assert_eq!(ViolationKind::FieldUnknown.as_expected_str(), "field_unknown");
    assert_eq!(ViolationKind::TypeMismatch.as_expected_str(), "type_mismatch");
    assert_eq!(ViolationKind::EnumViolation.as_expected_str(), "enum_violation");
}
