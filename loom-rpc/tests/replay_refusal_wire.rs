...
impl CoreFacadeBridge for ScriptedReplayBridge {
    ...
    fn create_session_raw(&self, _: &str, _: &str, _: Option<&str>, _: Option<u64>, _: Option<serde_json::Value>, _: bool, _: bool, _: Option<u64>) -> Result<(String, u64), LoomErrorCode> { Err(LoomErrorCode::InternalError) }
